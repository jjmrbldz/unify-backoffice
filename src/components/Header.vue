    ...
    <Menubar class="fixed top-0 m-2 header z-5" style="height: 68px;">
        <template #start>
            <RouterLink class="inline-flex max-h-full align-items-center" to="/">
                <img v-if="$store.state.lightThemeStore.lightTheme" class="" src="@/assets/img/kosca-solution-logo.png" alt="" height="40">
                <img v-else class="" src="@/assets/img/kosca-solution-logo-dark.png" alt="" height="40">
